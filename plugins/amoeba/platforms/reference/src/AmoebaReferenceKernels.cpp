...
ReferenceCalcGKNPForceKernel::ReferenceCalcGKNPForceKernel(const std::string& name, const Platform& platform, const System& system) : CalcGKNPForceKernel(name, platform) {
    gvol = 0;
}

ReferenceCalcGKNPForceKernel::~ReferenceCalcGKNPForceKernel(){
    if(gvol) delete gvol;
    positions.clear();
    ishydrogen.clear();
    radii_vdw.clear();
...
void ReferenceCalcGKNPForceKernel::initialize(const System& system, const AmoebaGKNPForce& force) {
...
void ReferenceCalcGKNPForceKernel::copyParametersToContext(ContextImpl& context, const AmoebaGKNPForce& force) {
